...
public class LancamentoServiceTest {
	...
	public void setUp() throws Exception {
		BDDMockito
				.given(this.lancamentoDao.findByFuncionarioId(Mockito.anyLong(), Mockito.any(PageRequest.class)))
				.willReturn(new PageImpl<Lancamento>(new ArrayList<Lancamento>()));
		BDDMockito.given(this.lancamentoDao.findOne(Mockito.anyLong())).willReturn(new Lancamento());
		BDDMockito.given(this.lancamentoDao.save(Mockito.any(Lancamento.class))).willReturn(new Lancamento());
	}
